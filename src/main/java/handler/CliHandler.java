...
public class CliHandler {
    ...
    //Запускает основной интерактивный цикл приложения.
    public void start() {
    ...
    //Парсит строку ввода и при необходимости запрашивает сложные объекты.
    ...
    //Считывает данные для создания/обновления HumanBeing из консоли
    ...
    //Считывает данные для объекта Car (может быть null).
    private Car readCar() {
